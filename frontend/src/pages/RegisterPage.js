...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex" data-testid="register-page">
      {/* Left Side - Form */}
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 py-12">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-slate-400 mb-8">Start verifying products in seconds</p>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="relative flex items-center justify-center p-12">
          <div className="max-w-md text-white">
            <h2 className="text-4xl font-bold mb-4">Shop smarter, not harder.</h2>
